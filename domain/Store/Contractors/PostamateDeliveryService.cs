...
namespace Store.Contractors
{
    public class PostamateDeliveryService:IDeliveryService
    {
        ...
        public string Title => "Доставка через постамат";
        ...
        {
            {"1",
                new Dictionary<string,string>{ {"1","Казанский вокзал"},{ "2", "Охотный Ряд" },{"3","Савеловский рынок" },
            }},

            {"2",
                new Dictionary<string,string>{ {"4","Московский вокзал"},{ "5", "Гостиный двор" },{"6","Петропавловская крепость" },
                } }
        }
        ;
